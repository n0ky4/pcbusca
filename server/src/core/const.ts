export const KABUM_BASE_URL = 'https://servicespub.prod.api.aws.grupokabum.com.br'
export const PICHAU_BASE_URL = 'https://www.pichau.com.br/api/catalog'
export const TERABYTE_BASE_URL = 'https://www.terabyteshop.com.br'
...
export const getRandomUA = () => uaList[Math.floor(Math.random() * uaList.length)]
